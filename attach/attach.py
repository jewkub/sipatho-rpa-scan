...
if __name__ == "__main__":
  ...
  for file in files:
    ...
    for surgicalNo in re.split('-| ', file.stem)[0].split(','):
      ...
      withsleep(pyautogui.write(surgicalNo), 0.1)
      withsleep(pyautogui.press('enter'), 0.4)
      withsleep(pyautogui.hotkey('ctrl', 'pagedown'), 0.1)
      withsleep(pyautogui.press('enter'), 0.8)
      withsleep(pyautogui.write(file.stem), 0.1)
      withsleep(pyautogui.press('down'), 0.2)
      withsleep(pyautogui.press('enter'), 5.0)
      withsleep(pyautogui.hotkey('ctrl', 'pagedown'), 0.1)
      withsleep(pyautogui.press('tab', presses=3), 0.1)
      withsleep(pyautogui.press('enter'), 0.4)
